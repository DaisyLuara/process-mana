  ...
  methods: {
    ...
    dateHandle(args) {
      if (
        ...
        args.start_get_date = handleDateTransform(this.filters.getDate[0]);
        args.end_get_date = handleDateTransform(this.filters.getDate[1]);
      }
      if (
        ...
        args.start_date = handleDateTransform(this.filters.beginDate[0]);
        args.end_date = handleDateTransform(this.filters.beginDate[1]);
      }
      return args;
    },
    getPersonRewardList() {
