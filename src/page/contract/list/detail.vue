<template>
  <div class="item-wrap-template">
    <div v-loading="setting.loading" :element-loading-text="setting.loadingText" class="pane">
      <div class="pane-title">合同{{ hide ? '详情' : '审批' }}</div>
      <el-form ref="contractForm" :model="contractForm" label-width="100px">
        ...
        <el-row>
          ...
          <el-col :span="12" v-if="contractForm.type_name !== '付款合同'">
        ...
        <el-row>
          ...
          <el-col v-if="contractForm.type_name !== '付款合同'" :span="12">
        ...
        <el-form-item>
          ...
          <el-button
            ...
            type="primary"
            size="small"
            @click="dialogFormVisible = true, rejectStatus=false, agreeStatus = true"
          >审核通过</el-button>
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="rejectAuditingHandle">确 定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    rejectAuditingHandle() {
      let args = {};
      // 法务主管
      if (this.legalAffairsManager && !this.contractForm.legal_ma_message) {
        this.warningInfo();
        return;
      } else {
      ...
      // 法务
      if (this.legalAffairs && !this.contractForm.legal_message) {
        this.warningInfo();
        return;
      } else {
