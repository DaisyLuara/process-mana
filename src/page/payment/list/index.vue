      ...
      <div class="item-content-wrap">
        ...
        <el-table 
          ...
          <el-table-column
            ...
            min-width="100"
          >
            <template slot-scope="scope">{{ scope.row.payment_payee_name }}</template>
          </el-table-column>
          <el-table-column
            :show-overflow-tooltip="true"
            prop="receive_status"
            ...
            min-width="80"
          >
            <template slot-scope="scope">{{ scope.row.receive_status }}</template>
          </el-table-column>
          <el-table-column
            :show-overflow-tooltip="true"
            prop="applicant_name"
          ...
          >
            <template
              slot-scope="scope"
            >{{ scope.row.handler_name === null ? '--' : scope.row.handler_name }}</template>
          </el-table-column>
          <el-table-column
            :show-overflow-tooltip="true"
            prop="created_at"
          ...
          <el-table-column 
            ...
            <template slot-scope="scope">
              ...
              <el-button
                ...
                size="mini"
                @click="auditingPayment(scope.row)"
              >审批</el-button>
              <el-button
              ...
              <!-- finance代表财务 -->
              <el-button
                v-if="scope.row.receive_status === '未收票' && finance"
                size="mini"
                type="warning"
...
export default {
  ...
  methods: {
    ...
    download(){
      ...
      delete args.page;
      return getExportDownload(this,downloadUrl.PAYMENT_EXPORT_API, args)
        .then(response => {
